...
def tag_trans_mat_callback(msg):
    rospy.loginfo("自发自收收到的tag_trans_mat数据: %s" % str(msg.data))

sub_test = rospy.Subscriber('tag_trans_mat', Float32MultiArray, tag_trans_mat_callback)
