...
def RL_Move(stage,target,robot):
    ...
    print("J1:",J1)
    # 加载模型
    model1 = PPO.load("/home/wangzy/FR5_exp/demo_ws/src/frcobot_ros/fr5_moveit_config/scripts/RL_weights_hyh/model1_pick.zip")
    model2 = PPO.load("/home/wangzy/FR5_exp/demo_ws/src/frcobot_ros/fr5_moveit_config/scripts/RL_weights_hyh/model2_place.zip")
    model3 = PPO.load("/home/wangzy/FR5_exp/demo_ws/src/frcobot_ros/fr5_moveit_config/scripts/RL_weights_hyh/model3_button.zip")
    model4 = PPO.load("/home/wangzy/FR5_exp/demo_ws/src/frcobot_ros/fr5_moveit_config/scripts/RL_weights_hyh/model4_grasp.zip")
    model5 = PPO.load("/home/wangzy/FR5_exp/demo_ws/src/frcobot_ros/fr5_moveit_config/scripts/RL_weights_hyh/model5_send.zip")
