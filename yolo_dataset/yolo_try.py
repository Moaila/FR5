...
model = YOLO('yolov8n.pt')  # 你可以选择更大的模型（如 'yolov8s.pt'）
# 图片路径
image_path = "/home/newplace/FR5/yolo_dataset/images/train/frame_20241224_160111.jpg"  # 替换为你的图片路径
output_path = "/home/newplace/FR5/yolo_dataset/images/val/frame_20241224_160111.jpg"  # 保存标记图片的路径
# 加载图片
print("[INFO] 读取图片...")
